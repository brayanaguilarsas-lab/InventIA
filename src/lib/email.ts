...
const FROM_EMAIL = process.env.FROM_EMAIL ?? 'inventario@saleads.com';
...
export function buildEntregaEmailHtml(params: {
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <p>Estimado/a <strong>${params.personName}</strong>,</p>
      ...
      <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
        <tr style="background: #f5f5f5;">
          ...
          <td style="padding: 8px 12px;">${params.assetCode}</td>
        </tr>
        <tr>
          <td style="padding: 8px 12px; font-weight: bold;">Activo</td>
          <td style="padding: 8px 12px;">${params.assetName}</td>
        </tr>
        <tr style="background: #f5f5f5;">
          <td style="padding: 8px 12px; font-weight: bold;">Fecha</td>
          <td style="padding: 8px 12px;">${new Date(params.date).toLocaleDateString('es-CO')}</td>
        </tr>
      </table>
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
        ...
        <tr>
          ...
          <td style="padding: 8px 12px;">${conditionText}</td>
        </tr>
      </table>
